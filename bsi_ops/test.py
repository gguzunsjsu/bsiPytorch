...
result, time_taken = bsi_ops.dot_product(m, n, 1000)
print("Result:", result)
print("Time Taken:", time_taken, "ns")

print('small stuff:: bsi:', result, 'torch.dot:', torch.dot(m, n))
print("Time taken for the BSI dot product", time_taken)
#
